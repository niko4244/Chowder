...
def main() -> int:
    ...
    lines = [
        ...
        "",
        "Mechanical output of `gap_rows`: no reference at a level renders as",
        "`unavailable`; nothing is normalized into fake parity.",
        "",
    ]
    ...
    if not any_comparable:
        lines.append(
            ...
            " Chowder records that honestly instead of rendering fake gaps."
        )
