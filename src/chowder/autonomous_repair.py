...
def _repairable_target(
    ...
    *,
    ...
    if candidate_id is not None:
        ...
        # Preserve tournament ordering: the first rejected result is the strongest
        # failed candidate according to score/efficiency ordering.
        candidate_ids = tuple(
    ...
    for experiment_id in candidate_ids:
        ...
        if repairable:
            # Largest failure cluster first; stable plan id breaks ties.
