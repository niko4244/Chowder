...
from ..executors import ExecutionContext, TrainingArtifact
...
class TransformersTextEvaluator:
    ...
    def evaluate(
        ...
        *,
        ...
        if not isinstance(metrics, Mapping) or not isinstance(suite_evidence, Mapping) or not isinstance(versions, Mapping):
        ...
        return ExperimentResult(
            ...
            gpu_hours=artifact.gpu_hours + elapsed / 3600.0,
